        ...
        <div className="auth-page-3d">
            ...
            <div className="auth-card-3d">
                <div className="auth-card-inner">
                    ...
                    <p className="auth-subtitle-3d">Your lifelong career and community hub</p>

                    <div className="auth-tabs-3d">
                        <Link to="/login" className="auth-tab-3d active">Sign In</Link>
                        <Link to="/register" className="auth-tab-3d">Sign Up</Link>
                    </div>
